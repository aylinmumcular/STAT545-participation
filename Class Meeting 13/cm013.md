...
1. Plot should be readable 
1. Plot should highlight the message conveyed
1. Plot should be scaled meaningfully (axes)
...
sys.setenv("plotly-username" = "??")
sys.setenv("plotly-api-key" = "??")

api_create(p, filename ="plotly example")


#Data to viz: suggests which type of visualization you should use based on your data
